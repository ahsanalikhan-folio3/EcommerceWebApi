...
namespace EcommerceApp.Infrastructure.Migrations
{
    ...
    [Migration("20260207213718_Added EmailVerificationOtp table for otp based verifications.")]
    partial class AddedEmailVerificationOtptableforotpbasedverifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Entities.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("LastMessagedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Entities.EmailVerificationOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Entities.Message", b =>
                {
                    ...
                    b.ToTable("Messages", null, t =>
                        {
                            t.HasCheckConstraint("CK_Message_SenderRole", "[SenderRole] IN ('Customer', 'Seller')");
                        });
                });
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Entities.Message", b =>
                {
                    b.HasOne("EcommerceApp.Domain.Entities.Chat", "CorrespondingChat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("EcommerceApp.Domain.Entities.ProductImage", b =>
                {
                    b.HasOne("EcommerceApp.Domain.Entities.Product", "CorrespondingProduct")
                        .WithMany("ProductImages")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CorrespondingProduct");
                });
